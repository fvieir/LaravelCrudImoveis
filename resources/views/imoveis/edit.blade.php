            ...
            <form method="post" action="{{ route('imoveis.update' , $imovel->id) }}"> 
                ...
                <hr>
                    ...
                    <hr>
                        ...
                        <div class="form-group">
                            <label for="lagradouroEndereco">Logradouro</label>
                            <input type="text" class="form-control" placeholder="Logradouro" required name="lagradouroEndereco" 
                            value="{{$imovel->lagradouroEndereco}}">
                        </div>
                    <div class="row">
                        <div class="col-md-10">
                            <div class="form-group">
